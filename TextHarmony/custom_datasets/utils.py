...
from .SegToImageDataset import SegToImageDataset
from .all_mixed_dataset import AllMixedDataset
...
def _build_dataset(config):
    ...
    elif config.name == "segment":
        dataset = SegmentDataset(
            annt_path=config.annt_path,
            transform=transform,
            total_length=getattr(config, "total_length", None),
            phase=config.phase,
            collate_mode=getattr(config, "collate_mode", "generate_images"),
    ...
    elif config.name == "SegToImage":
        dataset = SegToImageDataset(
            annt_path=config.annt_path,
            transform=transform,
            total_length=getattr(config, "total_length", None),
            phase=config.phase,
    ...
    elif config.name == "AllMixed":
        dataset = AllMixedDataset(
            annt_path=config.annt_path,
            transform=transform,
            total_length=getattr(config, "total_length", None),
            phase=config.phase,
